...
public class SDCStackProvider {
    ...
    public void start() {
        ...
        Modules.override(new org.somda.sdc.dpws.guice.DefaultDpwsModule())
                .with(
                        new MedstormSdcriConfigModule(), 
                        new com.medstorm.sdcbridge.MedstormJettyFactoryOverride(),
                        new com.medstorm.sdcbridge.patch.MedstormEventingPatchModule()
...
addIfPresent(lp,
    ...
    "org.somda.sdc.biceps.provider.services.GetService",
    "org.somda.sdc.glue.provider.services.GetService",
    // older variants you already had:
    "org.somda.sdc.biceps.provider.components.GetService",
    "org.somda.sdc.glue.provider.components.GetService"
);

if (lp.isEmpty()) {
    log.warn("GetService not found for LP; adding GetService to HP as fallback.");
    addIfPresent(hp,
        "org.somda.sdc.biceps.provider.services.GetService",
        "org.somda.sdc.glue.provider.services.GetService",
        "org.somda.sdc.biceps.provider.components.GetService",
